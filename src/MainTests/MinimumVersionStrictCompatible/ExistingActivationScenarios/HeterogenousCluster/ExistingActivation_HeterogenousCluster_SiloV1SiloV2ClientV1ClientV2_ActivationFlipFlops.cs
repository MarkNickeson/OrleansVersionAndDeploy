...
namespace MainTests.MinimumVersionStrictCompatible.ExistingActivationScenarios.HeterogenousCluster
{
    ...
    public class ExistingActivation_HeterogenousCluster_SiloV1SiloV2ClientV1ClientV2_ActivationFlipFlops : IAsyncLifetime
    {
        ...
        public ExistingActivation_HeterogenousCluster_SiloV1SiloV2ClientV1ClientV2_ActivationFlipFlops(TestProcessesFixture testProcesses)
        {
        ...
        [Fact]
        public async Task ClientV2GoesFirstAndActivatesOnV2Silo_ClientV1RequestThenCausesReactivationOnV1Silo()
        {
        ...
        [Fact]
        public async Task ClientV1GoesFirstAndActivatesOnV1Silo_ClientV2RequestThenCausesReactivationOnV2Silo()
        {
            Assert.True(_startSiloV1!.Success);
            Assert.True(_startClientV1!.Success);
            Assert.True(_startSiloV2!.Success);
